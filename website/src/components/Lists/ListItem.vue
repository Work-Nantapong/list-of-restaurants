...
export default {
  ...
  methods: {
    nearbySearch(place_id) {
      RestaurantDataService.findByPlaceID(place_id)
          .then((response: ResponseData) => {
            this.restaurantDetail = response.data.result;
            window.open(this.restaurantDetail.url, '_blank').focus();
          })
          .catch((e: Error) => {
            console.log(e);
          });
...
<template>
  <card class="d-flex flex-no-wrap card-item">
    <v-avatar
        class="ma-3"
        size="125"
        rounded="0"
    ...
    <card class="w-100">
      <card class="card-item-text text-h6">
        <slot name="title"></slot>
      </card>
      <card class="card-item-text">
...
.button-88:hover {
  box-shadow: 0 0.5em 1.5em -0.5em #36261c;
}

.button-88:active {
  box-shadow: 0 0.3em 1em -0.5em #36261c;
}
